...
-- DEVAM EDENLER (Bugün)
-- Bitis zamanı NULL
(5018, 3014, 5500, NOW() - INTERVAL '2 hours', NULL, 150, 30, 0),   -- Yeni başladı
(5019, 3015, 5501, NOW() - INTERVAL '4 hours', NULL, 80, 45, 1),    -- Ortada
(5020, 3016, 5502, NOW() - INTERVAL '1 hours', NULL, 50, 10, 0),    -- Yeni
(5021, 3012, 5506, NOW() - INTERVAL '5 hours', NULL, 200, 120, 3),  -- İlerledi
(5022, 3013, 5507, NOW() - INTERVAL '30 minutes', NULL, 100, 5, 0); -- Çok yeni
